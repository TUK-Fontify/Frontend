...
- `/images/brand/fontify-logo.png` (헤더, 푸터)
- `/images/my-page/activity-like-icon.svg` (메인 배너 소셜, 마이페이지 통계)
- `/images/my-page/activity-owned-font-icon.svg` (메인 배너 소셜, 마이페이지 통계)
- `/images/my-page/profile-avatar.png` (마이페이지 프로필)
- `/images/my-page/activity-review-icon.png` (마이페이지 통계)
